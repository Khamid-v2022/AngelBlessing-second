...
class ConnectingAngels extends CI_Controller {
    ...
    {
        $posts = $this->welcome_m->get_wp_posts_with_image("Connecting With Angels");
        $show_posts = [];
        // pick random 6 posts
        if(count($posts) <= 6){
            $show_posts = $posts;
        ...
        $data['title'] = "Choose Your Methods To Connecting With Your Angels Today";
        $this->load->view('header', $data);
        $this->load->view('connecting_angels', $data);
